...
class  Migration
{
                ...
                try
                {
                  ...
                  $mrsfall= new PDO (DB_DSN_POSTGRES,DB_USER_POSTGRES,DB_PASS_POSTGRES,[PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_ASSOC]
                    ...
                    } else
                    {
                      ...
                      $this->pdo=new PDO("pgsql:host=ballast.proxy.rlwy.net;dbname=railway;port=42578","postgres","SPLHdRWAdToAzpTOdrgieVnYIGvNoVrj",
            [
        ...
        public function  createTable()
        {
            ...
            {
                "mysql" =>file_get_contents( __DIR__. "/../database/script_create_mysql.sql"),
                'pgsql'=>file_get_contents( __DIR__. "/../database/script_create_psql.sql"),
